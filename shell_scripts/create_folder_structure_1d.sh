...
results_dir=$1
destination_dir=$2
python_script='/Users/Selim/Documents/Etudes/Automne 2020 Master Robotique/BioRob Semester Project/switchdrive/Biorob_semester_project/src/rename_optim_folder_1d.py'
current_dir=$(pwd)
