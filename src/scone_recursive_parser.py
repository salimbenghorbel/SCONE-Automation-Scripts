...
def generate_controllers_with_key_combinations(series, key_dict_list, output_folder_path, scone_base_files_path, main_file_name):
    '''
    ...
    for value_combination in value_combinations:
        ...
        for dict_id in range(n_dict):
            ...
            set_key(combination_series, key_dict['key_name'], key_value, key_dict['states'], key_dict['target'], key_dict['source'])
